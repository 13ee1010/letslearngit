...
#fin = "./data/cm_256_16x16_1.5.pkl"   #19 radius 
#fin = "./data/cm_128_8x8_1.5.pkl"
#fin = "./data/cm_102_5x5_1.5.pkl"
#fin = "./data/cm_256_8x8_2.0_8_30.5.pkl"    # 30 radius
...
#fin ="./data/cm_1024_51x51_2.0_8_1.1.pkl"
#fin = "./data/cm_128_4x4_2.0_8_1.7.pkl"
#fin = "./data/cm_1024_32x32_2.0_8_10.1.pkl"
    ...
    for i in range (len(est)):
        for j in range(len(est)):
            if(i==j):
                ...
                if(check <= 4.2):
                    neighbour1[count1] = n_lense_norm[i]
                    count1 = count1 + 1
                    
                

                if(check2 <= 1100):
                    neighbour2[count2] = n_est_norm[i]
                    count2 = count2 + 1
...
#y, z, n = est[:,0], est[:,1], est[:,2]
draw_circle = plt.Circle((centreX1, centreY1),33.16,fill=False)
axs.set_aspect(1)
