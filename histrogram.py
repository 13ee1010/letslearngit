...
def distance_fun(lens, est):
    ...
    for i in range(len(est)):
        ...
        for j in range(len(est)):
            ...
            euclidian_distance[i][j] = np.sqrt(np.square(range_1-range_est_1) + np.square(range_2-range_est_2) + np.square(range_3-range_est_3) + np.square(range_4 - range_est_4) + np.square(range_5 - range_est_5) + np.square(range_6 - range_est_6) + np.square(range_7 - range_est_7) + np.square(range_8 - range_est_8) + np.square(range_9 - range_est_9))
            manhatten_distance[i][j] = abs(range_1 - range_est_1) + abs(range_2-range_est_2) + abs(range_3-range_est_3) + abs(range_4 - range_est_4) + abs(range_5 - range_est_5) + abs(range_6 - range_est_6) + abs(range_7 - range_est_7) + abs(range_8 - range_est_8) + abs(range_9 - range_est_9)
